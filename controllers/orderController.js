...
//     const { formData, totalPrice, paymentMethod, paymentDetails } = req.body;
//     const { razorpay_order_id, error } = paymentDetails;
//     const { address, couponCode } = formData;

//     console.log("payment failed success");
...
//     // We don't update product stock or clear the cart for failed orders
...
//     res.status(500).json({
//       success: false,
//       message: "Failed to record failed order due to server error.",
//     });
//   }
// };
...
//           return res.status(400).json({
//               success: false,
//               message: 'Invalid order for retry'
//           });
//       }

//       // Create new Razorpay order
//       const options = {
//           amount: failedOrder.totalPrice * 100,
//           currency: "INR",
...
//                           couponCode: failedOrder.couponUsed
//                       }
//                   }
//               });
//           } else {
//               res.status(500).json({
//                   success: false,
//                   message: "Failed to create new payment order"
//               });
//           }
//       });
//   } catch (error) {
